...
<html lang="en">
  <head>
    ...
    <title>Tour Planner-CONFIRM BOOKING</title>
              ...
              <form action="book_now.php" method="POST" id="booking_form">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    ...
                    <button name="book_now" class="btn w-100 text-white custom-btn-bg shadow-none mb-1" disabled>Book Now</button>
                  </div>
                </div>
              </form>
            </div>
        ...
        if(checkin_val != '' && checkout_val != ''){
          ...
          xhr.onload = function(){
            ...
            if(data.status == 'check_in_out_equal'){
              ...
              pay_info.innerText = "Check-in date is earlier than check-in date!";
            }
